...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + 'infos/vad_nuscenes_infos_temporal_train.pkl',
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             pc_range=point_cloud_range,
             ann_file=data_root + 'infos/vad_nuscenes_infos_temporal_val.pkl',
...
evaluation = dict(interval=5, pipeline=test_pipeline, metric='bbox', map_metric='chamfer')
